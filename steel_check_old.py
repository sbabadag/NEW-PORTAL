...
def check_deflections(nodes, span, h1, h2, design_code="Eurocode 3 (EN)"):
    """
    Check deflection limits according to design code
    ...
    try:
        # Calculate actual deflections from node displacements
        # Node indices: 0=left base, 1=left top, 2=ridge, 3=right top, 4=right base
